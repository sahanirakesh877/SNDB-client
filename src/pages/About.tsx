...
const About: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>About Us | Society of Nepal Doctors of Bangladesh</title>

        {/* Meta description for SEO */}
        <meta
          name="description"
          content="Society for Nepalese Doctors from Bangladesh (SNDB) is a non-political, non-profitable organization for Nepalese doctors who have studied in Bangladesh. Learn more about SNDB, its goals, and its contributions to healthcare services in Nepal."
        />

        {/* Keywords for the page */}
        <meta
          name="keywords"
          content="Nepalese doctors, Bangladesh doctors, SNDB, healthcare in Nepal, medical professionals"
        />
      </Helmet>
      ...
      <div className="sm:flex items-center max-w-7xl mx-auto  py-8">
        <div className="sm:w-1/2 p-5">
          <div className="text">
            ...
            <p className="text-gray-700 text-justify my-2">
              {" "}
