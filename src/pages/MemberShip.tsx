          ...
          <div className="bg-white p-6 shadow-lg rounded-lg">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                fulfilling any one of the following criteria can apply for life 
                membership of SNDB:
              </p>
              <ul className="list-disc list-inside text-gray-600 space-y-2 text-sm">
                ...
                <li>
                  ...
                  gastroenterology following MS or equivalent from a recognized
                  institute with one year clinical fellowship in surgical
                  gastroenterology.
                </li>
              </ul>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mb-4 text-sm">
                Doctors related to other fraternities of medical sciences except
                surgical gastroenterology, as well as non-medical personnel who
                are interested in becoming a member, can apply.
              </p>
            ...
            <div className="mb-2">
              ...
              <p className="text-gray-600  text-sm">
                ...
                international citizens, who have made significant contributions
                to the field of surgical gastroenterology or to the organization
                as decided by the executive committee meeting.
              </p>
            </div>
            ...
            <div className="mb-2">
              <p className="text-gray-600 text-sm">
                ...
                with the required documents to the secretary, or the filled form
                can be scanned along with a scanned copy of the necessary
            ...
            <div className="mt-3">
              ...
              <p className="text-gray-600">
                ...
                <br />
                <strong>Account Name:</strong>Society For Nepalese Doctors from
                Bangladesh (SNDB)
                <br />
